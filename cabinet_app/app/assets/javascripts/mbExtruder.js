  ...
  $.mbExtruder= {
    ...
    buildMbExtruder: function(options){
      return this.each (function (){
        ...
        var c= $("<div/>").addClass("extruder-content").css({overflow:"scroll", width:extW});
        ...
        if (extruder.attr("extUrl")){
          ...
          var container=$("<div>").addClass("text").css({width:extruder.get(0).options.width-20, overflowY:"scroll"});
    ...
    openMbExtruder:function(c){
      ...
      if (position=="top" || position=="bottom"){
        ...
        extruder.find('.extruder-content').css({overflowX:"scroll", display:"block"});
    ...
    closeMbExtruder:function(){
      ...
      if (opt.position=="top" || opt.position=="bottom"){
        ...
        extruder.find('.extruder-content').css({overflow:"scroll"});
        extruder.find('.extruder-content').animate({ width: 1 }, opt.slideTimer,function(){
          extruder.find('.ext_wrapper').css({width:1});
          extruder.find('.extruder-content').css({overflow:"scroll",display:"none"});
          if(opt.onExtClose) opt.onExtClose();
        });
      }
    }
